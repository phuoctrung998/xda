...
class ClsFTP{
    var $host = "139.180.132.205";//FTP HOST
    var $port = "22";        //FTP port
    var $user = "apkmetricscom";//FTP user
    var $pass = "80219225b269e387af534";    //FTP password
    ...
    function ClsFTP($user="Anonymous",$pass="Email",$host="localhost",$port="22"){
