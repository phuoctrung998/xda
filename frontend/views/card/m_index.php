...
<div id="loading-payment" style="position: fixed; overflow: auto; z-index: 100001; width: 100%; height: 100%; top: 0px; left: 0px;display: none">
	...
	<?php if(!Yii::$app->user->isGuest){?>
		<input type="hidden" value="<?=$infoMember->member_username?>" id="txtMemberLoged">
			<div class="top-title">
			Chào đạo hữu: <span><?=$infoMember->member_username?></span> 
		</div>
	<?php }else{ ?>
		<div class="top-title">
			Chào đạo hữu!
			...
			<div class="inner choose-card-container" style="display: block;">
				...
				<div class="content-tab-card">
					<div class="inner-child" style="display: none;">
						<div class="step">
							<p>HƯỚNG DẪN NẠP THẺ BẰNG MOMO</p>
							<p>BƯỚC 1: 	CHUYỂN KHOẢN VÀO VÍ MOMO THEO VÍ: <span>0934697738</span> .
							NỘI DUNG CHUYỂN KHOẢN: TuTienH5 - TÀI KHOẢN, SERVER ĐANG CHƠI.</p>
							<p>BƯỚC 2: 	NHẮN FANPAGE ADMIN GAME <a target="_blank" href="https://www.facebook.com/phamnhantutien.H5/">FANPAGE 
Phàm Nhân Tu Tiên H5</a> .</p>
						</div>
					</div>
					<div id="nc-gate" class="inner-child" style="display: none;">
							...
							<div class="btn-submit text-center">
								<button type="button" onclick="return validateFormVTPPaymentGate('f-nc-gate')">NẠP THẺ</button>
							</div>
						</form>
						<?php }else{ ?>
					...
					<div class="inner-child active" style="display: block;">
						<div class="step">
							<p>TOP UP BY PAYPAL AS BELOW:</p>
							<p>STEP 1: 	SEND MONEY FOR PAYPAL ACCOUNT: <span>TRAM.NGUYEN@VNGOS.COM</span> .</p>
							<p>STEP 2: 	THEN, CHATTING WITH ME BY FACEBOOK ( MESSAGE )
									RATE : 10 USD = 2200 GOLD , 50 USD = 11.000 GOLD
									LINK <a target="_blank" href="https://www.facebook.com/phamnhantutien.H5/">FANPAGE 
Phàm Nhân Tu Tiên H5</a> .</p>
						</div>
					</div>
				</div>
