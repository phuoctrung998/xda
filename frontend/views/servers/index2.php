...
$styleUrl 		= Yii::getAlias('@webDomain').'/style/teaser2';
?>
<?php $this->beginPage() ?>
    <!doctype html>
<html>
    ...
    <div class="box-game">
        ...
        <div class="menu-mb" style="display: none">
            ...
            <a class="btn-popupDangnhapMb btn-popupDangnhap">
				<img src="<?=$styleUrl?>/images/mobile/menu/mb-dangky.png" width="100%">
			</a>
			<a href="/">
...
<div class="popupDangnhapPc alert-1-2 popup" data-sm-init="true">
    <div class="popupDangnhap-image">
        ...
        <div class="popupDangnhap-line"><img src="<?=$styleUrl?>/images/popup/line2.png"></div>
        <div class="popupDangnhap-dangnhapbang">
            <ul>
				...
				<li style="float: left;" id="my-signin2" class="cursor">
					<a href="<?=$gg_login_url?>">
