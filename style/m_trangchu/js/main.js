(function($) {
	...
	// 	$('.choose-card li').click(function() {
	// 	 var $liIndex = $(this).index() + 1;
	// 	 console.log($liIndex);
	// 	 $('.choose-card li').removeClass('active');
	// 	 $(this).addClass('active');
	// 	 $('.content-tab-card .inner-child').hide();
	// 	 $('.content-tab-card .inner-child:nth-child(1)').show();
	// 	 $('.content-tab-card .inner-child:nth-child('+$liIndex+')').show();
	//  });
	// });
